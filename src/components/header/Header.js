                ...
                <div class="navbar-start">
                    <div class="dropdown">
                        ...
                        <ul tabIndex='0' class="menu menu-compact dropdown-content mt-3 p-2 shadow bg-base-100 rounded-box w-52">
                            ...
                            <li><Link className='text-xl' to='/#skill'>My Skill</Link></li>
                            <li><Link className='text-xl' to='/#about'>About Me</Link></li>
                            <li><Link className='text-xl' to='/#ido'>What I Do</Link></li>
                            <li><Link className='text-xl' to='/#project'>Project</Link></li>
